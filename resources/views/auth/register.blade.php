...
<div class="bahrami1">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group row">
            <div class="col-md-11">
                <input required id="phone" type="text" class="form-control @error('email') is-invalid @enderror" name="phone"
                       value="{{ old('phone') }}" autocomplete="phone" autofocus>
                <span class="floating-label">شماره</span>
                @error('number')
                <span class="invalid-feedback" role="alert">
                                         <strong>{{ $message }}</strong>
                                    </span>
        ...
        <div style="text-align: center">
            <a class="signin" href="{{route('login')}}"> ورود به سایت&nbsp;</a>
